<#
.SYNOPSIS
Hard-Coded Launcher for ScanSnap Home Installation

.DESCRIPTION
Hard-coded launcher that downloads and executes ScanSnapHome.ps1 from GitHub with:
...
# All environment variables will be passed to ScanSnapHome.ps1

.NOTES
Version: 4.0.0
Author: Datto RMM Function Library
Compatible: PowerShell 2.0+, Datto RMM Environment
Script: ScanSnapHome.ps1 (ScanSnap Home Installation)
#>
...
$SCRIPT_PATH = "components/Applications/ScanSnapHome.ps1"
$SCRIPT_TYPE = "Applications"
$SCRIPT_DISPLAY_NAME = "ScanSnap Home Installation"
# ============================================
...
$transcriptPath = "$LogDir\ScanSnapHome-Launcher-$timestamp.log"
